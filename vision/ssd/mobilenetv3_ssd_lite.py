...
def create_mobilenetv3_large_ssd_lite(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=True, is_test=False):
    ...
    regression_headers = ModuleList([
        ...
        SeperableConv2d(in_channels=960, out_channels=6 * 4, kernel_size=3, padding=1, onnx_compatible=onnx_compatible),
    ...
    classification_headers = ModuleList([
        SeperableConv2d(in_channels=round(112 * width_mult), out_channels=6 * num_classes, kernel_size=3, padding=1, onnx_compatible=onnx_compatible),
        SeperableConv2d(in_channels=960, out_channels=6 * num_classes, kernel_size=3, padding=1, onnx_compatible=onnx_compatible),
...
def create_mobilenetv3_small_ssd_lite(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=True, is_test=False):
